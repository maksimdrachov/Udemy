...
##
## Debug
ProjectName            :=MyChallengeSolution
ConfigurationName      :=Debug
WorkspacePath          :=/Volumes/Seagate/Udemy/C-Course/Section16
ProjectPath            :=/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution
...
ObjectsFileList        :="MyChallengeSolution.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix): I_Printable.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/I_Printable.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/I_Printable.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Trust_Account.cpp$(ObjectSuffix): Trust_Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/Trust_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Trust_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix): Savings_Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/Savings_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Savings_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix): Checking_Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/Checking_Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Checking_Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account.cpp$(ObjectSuffix): Account.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/Account.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix): Account_Util.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/Account_Util.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Account_Util.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/Volumes/Seagate/Udemy/C-Course/Section16/MyChallengeSolution/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
